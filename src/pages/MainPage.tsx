...
function MainPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[url('/src/assets/bg.png')] bg-no-repeat bg-center bg-auto md:bg-cover py-6 px-5 overflow-auto">
        <div className="w-2/3 mx-auto bg-white/80 backdrop-blur border-b border-gray-200 p-20 relative overflow-hidden">
          <div className="flex mx-auto max-w-5xl items-center justify-between px-6 py-4">
            ...
            >
              <p className="text-2xl font-medium text-gray-700 cursor-pointer">🔰 チュートリアル</p>
            </div>
          </div>
          ...
          <div className="flex mx-auto max-w-5xl items-center justify-between px-6 py-10">
            ...
            {showTutorialPrompt && (
              <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50">
                <div className="bg-white p-8 rounded-2xl text-center max-w-md w-[90%] shadow-2xl">
                  <h2 className="text-2xl font-bold mb-4 text-gray-800">ならげっさーの世界へようこそ！</h2>
                  <p className="text-gray-600 mb-8 text-lg">チュートリアルを行いますか？</p>
            ...
            {showLoginAlert && (
              ...
              >
                <div
                  className="bg-white p-8 rounded-2xl text-center max-w-md w-[90%] shadow-2xl"
                  onClick={(e) => e.stopPropagation()}
                >
                  <h2 className="text-2xl font-bold mb-4 text-gray-800">ショップはログイン後に利用できます</h2>
                  <p className="text-gray-600 mb-8 text-lg">ログインしてからもう一度お試しください。</p>
